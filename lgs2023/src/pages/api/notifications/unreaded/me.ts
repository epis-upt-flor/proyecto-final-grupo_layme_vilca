...
export default async function handler(req : NextApiRequest , res: NextApiResponse){
    ...
    const queryReaded = query(collectionNotification,where("read","==",false),where("toUserId","==",userId))
    
    const querySnapshot = await getDocs(queryReaded)
    ...
    console.log({unreadeds : response})
